...
![image](https://user-images.githubusercontent.com/61315339/220929221-0a1e04e1-41fe-4e61-8c69-02e15079d9cd.png)
...
## LEDs
set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS33 } [get_ports { sig_f_O[0] }]; #IO_L18P_T2_A24_15 Sch=led[0]
set_property -dict { PACKAGE_PIN K15   IOSTANDARD LVCMOS33 } [get_ports { sig_f_O[1] }]; #IO_L24P_T3_RS1_15 Sch=led[1]
set_property -dict { PACKAGE_PIN J13   IOSTANDARD LVCMOS33 } [get_ports { sig_f_O[2] }]; #IO_L17N_T2_A25_15 Sch=led[2]
